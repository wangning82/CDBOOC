...
public class __UI__
{
	...
	public static void uiImpl()
	{
		...
		UIManager.put("Table.scrollPaneBorder",new BorderUIResource(new TableScrollBorder()));//defaut is com.sun.java.swing.plaf.windows.XPStyle.XPFillBorder
		UIManager.put("Table.focusCellHighlightBorder",new BorderUIResource(new FocusCellHighlightBorder()));//new BEDashedBorder(new Color(0,160,0),1,0,true,false,true,false)));
