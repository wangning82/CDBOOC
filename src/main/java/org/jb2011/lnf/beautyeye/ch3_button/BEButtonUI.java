			...
			if(toolbar)
			{
				...
				if(model.isRollover()||model.isPressed())
				{
					if(c instanceof JToggleButton)
						org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getToggleButtonIcon_RoverGreen().draw((Graphics2D)g, dx, dy, dw, dh);
					else
						org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getButtonIcon_PressedOrange().draw((Graphics2D)g, dx, dy, dw, dh);
				}
				else if(model.isSelected())//state == State.CHECKED)//||state == State.HOTCHECKED)
				{
					org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getToggleButtonIcon_CheckedGreen().draw((Graphics2D)g, dx, dy, dw, dh);
				}
				else
				{
...
//					else if(state == State.DISABLED)
						...
						org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getButtonIcon_DisableGray().draw((Graphics2D)g, dx, dy, dw, dh);
					else if(model.isRollover())
						org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getButtonIcon_rover().draw((Graphics2D)g, dx, dy, dw, dh);
					else
					{
						if(nomalColor==NormalColor.green)
						{
							org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getButtonIcon_NormalGreen().draw((Graphics2D)g, dx, dy, dw, dh);
						}
						else if(nomalColor==NormalColor.red)
						{
							org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getButtonIcon_NormalRed().draw((Graphics2D)g, dx, dy, dw, dh);
						}
						else if(nomalColor==NormalColor.blue)
						{
							org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getButtonIcon_NormalBlue().draw((Graphics2D)g, dx, dy, dw, dh);
						}
						else if(nomalColor==NormalColor.lightBlue)
						{
							org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getButtonIcon_NormalLightBlue().draw((Graphics2D)g, dx, dy, dw, dh);
						}
						else if(nomalColor==NormalColor.grey)
						{
							org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getButtonIcon_SpecialGray().draw((Graphics2D)g, dx, dy, dw, dh);
						}
//						else if(nomalColor==NormalColor.red)
//						{
...
//						}
							...
							org.jb2011.lnf.beautyeye.ch3_button.__Icon9Factory__.getInstance().getButtonIcon_NormalGray().draw((Graphics2D)g, dx, dy, dw, dh);
					}
				}
				catch (Exception e)
				{
